...
var memosData = {
  ...
  <div class="user-now card-item flex-fill mb-3 row" style="display: none;">
    <div class="call-memos-editor item-avatar p-3 "><img class="user-now-avatar" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7"/ style="pointer-events: none;">
  ...
  async function updateHtml(data) {
    ...
    for (var i = 0; i < data.length; i++) {
      ...
      let memosLink = "https://s.dusays.com/u/summer";
